...
import { ShoppingCart, Package, MapPin, CreditCard, User } from "lucide-react";
...
export function SaleViewModal({ open, onOpenChange, order }: Props) {
                  ...
                  <div key={item.id} className="flex items-center justify-between p-3 border rounded-lg">
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-2 text-sm text-muted-foreground">
                        ...
                        <span>•</span>
                        <Badge variant="outline" className="text-xs">{item.productSnapshot.size}</Badge>
                      </div>
                    </div>
