...
import type { LandingProduct } from "@/types/dto/product.dto";
...
export default function ProductCard({ product }: { product: LandingProduct }) {
      ...
      <div className="px-4 pb-4">
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="bg-white/[0.15] hover:bg-white/[0.25] text-white px-4 py-1.5 rounded-full text-xs font-normal transition-all duration-200"
          >
            <ArrowRight />
          </button>
        </div>
